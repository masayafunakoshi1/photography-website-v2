    ...
    <div className="contactsAndSocials">
      <div className="contacts">
        ...
        <div className="contactIcons">
          ...
          <a onClick={(e) => handleIconClick(e)} className="contactsText">
            845-490-7124
          </a>
        </div>
      ...
      <div className="socials">
        <a href="https://www.instagram.com/masayafunakoshi1/" target="_blank">
          <InstagramIcon
            style={{ fontSize: 40, color: "#833AB4" }}
            className="socialIcons"
          />
        </a>
        <a
          href="https://www.youtube.com/channel/UCRpd_34DrsYww62MJ34y-3Q"
          target="_blank"
        >
          <YouTubeIcon
            style={{ fontSize: 40 }}
        ...
        <a href="https://www.linkedin.com/in/masayafunakoshi/" target="_blank">
          <LinkedIn
            style={{ fontSize: 40, color: "#0e76a8" }}
            className="socialIcons"
          />
        </a>
      </div>
