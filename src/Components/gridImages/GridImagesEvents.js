          ...
          <Grid container justify="center" spacing={2}>
            <Grid item sm={12} md={6} lg={4} xl={4} className="gridImage">
              <img
                ...
                alt="filler"
              />
              <Modal open={openImage === 7} onClose={handleClose}>
                <img
                  src={showImage(0)}
            ...
            <Grid item sm={12} md={6} lg={4} xl={4} className="gridImage">
              <img
                ...
                alt="filler"
              />
              <Modal open={openImage === 8} onClose={handleClose}>
                <img
                  src={showImage(1)}
                  className={classes.paper}
                  alt="filler"
            ...
            <Grid item sm={12} md={6} lg={4} xl={4} className="gridImage">
              <img
                ...
                alt="filler"
              />
              <Modal open={openImage === 9} onClose={handleClose}>
                <img
                  src={showImage(2)}
                  className={classes.paper}
                  alt="filler"
          ...
          <Grid container justify="center" spacing={2}>
            <Grid item sm={12} md={6} lg={4} xl={4} className="gridImage">
              <img
                ...
                alt="filler"
              />
              <Modal open={openImage === 10} onClose={handleClose}>
                <img
                  src={showImage(3)}
                  className={classes.paper}
                  alt="filler"
            ...
            <Grid item sm={12} md={6} lg={4} xl={4} className="gridImage">
              <img
                ...
                alt="filler"
              />
              <Modal open={openImage === 11} onClose={handleClose}>
                <img
                  src={showImage(4)}
                  className={classes.paper}
                  alt="filler"
            ...
            <Grid item sm={12} md={6} lg={4} xl={4} className="gridImage">
              <img
                ...
                alt="filler"
              />
              <Modal open={openImage === 12} onClose={handleClose}>
                <img
                  src={showImage(5)}
                  className={classes.paper}
                  alt="filler"
