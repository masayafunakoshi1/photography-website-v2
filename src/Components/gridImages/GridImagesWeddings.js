        ...
        <div className="firstSegment">
            ...
            <h1 className="sectionTitles">Weddings</h1>
                ...
                {/* <Grid container justify="center" spacing={2}>
                    ...
                    <Grid container justify="center" spacing={2}>
                        <Grid item sm={12} md={6} lg={4} xl={4} className="gridImage">
                         ...
                         <img src={showImage(0)} className={classes.img} onClick={() =>{handleOpen(1)}} alt="filler"/>
                        ...
                        <Grid item sm={12} md={6} lg={4} xl={4} className="gridImage">
                            <img src={showImage(1)} className={classes.img} onClick={() =>{handleOpen(2)}} alt="filler" />
                            <Modal
                            open={openImage === 2}
                            onClose={handleClose}
                            >
                        ...
                        <Grid item sm={12} md={6} lg={4} xl={4} className="gridImage">
                            <img src={showImage(2)} className={classes.img} onClick={() =>{handleOpen(3)}}  alt="filler" />
                            <Modal
                                open={openImage === 3}
                                onClose={handleClose}
                                >
                ...
                <FadeInSections>
                    <Grid container justify="center" spacing={2}>
                        <Grid item sm={12} md={6} lg={4} xl={4} className="gridImage">
                            <img src={showImage(3)} className={classes.img} onClick={() =>{handleOpen(4)}} alt="filler" />
                             <Modal
                                open={openImage === 4}
                                onClose={handleClose}
                                >
                        ...
                        <Grid item sm={12} md={6} lg={4} xl={4} className="gridImage">
                            <img src={showImage(4)} className={classes.img} onClick={() =>{handleOpen(5)}} alt="filler" />
                             <Modal
                                open={openImage === 5}
                                onClose={handleClose}
                                >
                        ...
                        <Grid item sm={12} md={6} lg={4} xl={4} className="gridImage">
                            <img src={showImage(5)} className={classes.img} onClick={() =>{handleOpen(6)}} alt="filler" />
                            <Modal
                                open={openImage === 6}
                                onClose={handleClose}
                                >
